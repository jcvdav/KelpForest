...
ind_2011 <- Stot %>% 
  ...
  mutate(year = 2011) %>% 
  mutate(group = fct_relevel(group, c("D'", "J / Lambda", "Shannon")))
...
```{r, fig.height = 8.5, fig.width = 6, fig.cap = "nMDS for sites by bottom (A), and midwater (A)."}
