...
```{r}
all_sheets <- readxl::excel_sheets("../Raw/KelpForestFish/datos2013.xls")
...
all_data <- read_excel_allsheets("../Raw/KelpForestFish/datos2013.xls")
...
tidy_data <- tidy_data %>% 
  ...
  select(ID, Site, Zone, Level = Habitat, Transect, Class, Order, Family, Genus, GenusSpecies, Length, Abundance, aTL2TW = a, bTL2TW = b, TrophicLevel, Lm, Lmax, BodyShape = BodyShapeI, DemersPelag, PriceCateg, UsedasBait, Aquarium, Importance, Comments)
